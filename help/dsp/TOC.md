...
+ 营销活动管理{#campaign-management}
   ...
   + 包{#packages}
      ...
      + [编辑资源包](/help/dsp/campaign-management/packages/package-edit.md)
   ...
   + 广告{#ads}
      ...
      + Advertising Cloud投放的广告{#advertising-cloud-served}
   ...
   + 使用电子表格{#qa-spreadsheet}更正营销活动的版面设置
...
+ 优化{#optimization}
   + [如何 [!DNL DSP] 优化您的营销活动](/help/dsp/optimization/optimization-how-dsp-optimizes-campaigns.md)
...
+ 清单{#inventory}
   ...
   + [!DNL On Demand] 库存  {#on-demand}
      ...
      + 可用的[!DNL On Demand]高级库存发布器{#publishers}
      ...
      + [订阅并请求 [!DNL On Demand] 高级库存交易的访问权限](/help/dsp/inventory/on-demand-inventory-subscribe.md)
   ...
   + 专用清单{#private-inventory}
      ...
      + 程序化保证交易{#programmatic-guaranteed-deal}
         ...
         + [!DNL FreeWheel] 程序化保证交易  {#freewheel}
            + [ [!DNL FreeWheel]中设置程序化保证交易概述](/help/dsp/inventory/freewheel-overview.md)
            + [向 [!DNL FreeWheel]提交程序化保证交易的广告](/help/dsp/inventory/freewheel-submit.md)
            + [检查 [!DNL FreeWheel] 程序化保证交易的广告状态](/help/dsp/inventory/freewheel-check-status.md)
