...
| [!UICONTROL Goals] | [!UICONTROL Day parting] | 分时段是&#x200B;*[!UICONTROL ON]*&#x200B;还是&#x200B;*[!UICONTROL OFF]*。<br><b>注意：</b> 要检查实际的分时段计划，请在中打开版面设 [!DNL DSP]置。 | — |
...
| [!UICONTROL Goals] | [!UICONTROL Pace on] | 投放是朝&#x200B;*[!UICONTROL Budget]*&#x200B;还是&#x200B;*[!UICONTROL Impressions]*&#x200B;步调。 | — |
| [!UICONTROL Goals] | [!UICONTROL Max Bid] | 版面的最高竞价。 | 是 |
| [!UICONTROL Goals] | [!UICONTROL Pacing Fill Strategy] | 投放的步调填充策略：*[!UICONTROL evenly]*、*[!UICONTROL frontload]*&#x200B;或&#x200B;*[!UICONTROL aggressive frontload]*。 | 是 |
...
| [!UICONTROL Goals] | [!UICONTROL Frequency Cap] | 指定[!UICONTROL Frequency Cap Interval]期间放置的主频上限。 | 是 |
| [!UICONTROL Goals] | [!UICONTROL Frequency Cap Interval] | 主频率上限的间隔：*[!UICONTROL Day]*、*[!UICONTROL Week]*&#x200B;或&#x200B;*[!UICONTROL Month]*。 | 是 |
| [!UICONTROL Goals] | [!UICONTROL Secondary Frequency Cap] | 指定[!UICONTROL Secondary Frequency Cap Interval]期间放置的次频上限 | 是 |
| [!UICONTROL Goals] | [!UICONTROL Secondary Frequency Cap Interval] | 次频上限的间隔类型：*[!UICONTROL Week]*、*[!UICONTROL Day]*、*[!UICONTROL Hour]*&#x200B;或&#x200B;*[!UICONTROL Minute]*。 [!UICONTROL Secondary Frequency Cap Interval Value]表示适用的周数、天数、小时数或分钟数。 | 是 |
| [!UICONTROL Goals] | [!UICONTROL Secondary Frequency Cap Interval Value] | [!UICONTROL Secondary Frequency Cap]适用的周、天、小时或分钟数。 例如，如果次要上限为每6小时3次展示次数，则此处的值为<b>6&lt;/>。 | 是 |
