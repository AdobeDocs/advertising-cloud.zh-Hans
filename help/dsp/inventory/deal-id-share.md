---
title: 编辑具有交易ID访问权限的帐户
description: 了解如何与不同帐户共享和停止共享交易ID。
...
您可以停止与帐户共享交易以删除编辑和定位功能，但这些帐户在报表视图中仍可以看到信息源。
...
1. 在交易行中，单击 ![“选项”菜单](/help/dsp/assets/options-menu.png) **>[!UICONTROL share]**.

1. 对于要共享的每个帐户：

1. 输入 **[!UICONTROL Email Address]** 对交易具有访问权限的帐户。
