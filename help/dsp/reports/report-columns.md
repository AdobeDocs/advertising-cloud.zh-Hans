...
| [!UICONTROL Dimension] | [!UICONTROL Date/Time] | 第[!UICONTROL of Week]天 | 具体日期，如[!UICONTROL Monday]或[!UICONTROL Tuesday]。 |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Environment] | 广告是显示在&#x200B;*[!UICONTROL sites]*&#x200B;还是&#x200B;*[!UICONTROL Apps]*&#x200B;上。 |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Operating System Version] | 显示广告的操作系统版本（如[!UICONTROL Windows 10]或[!UICONTROL iOS Mojave]） |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Average Frequency] | 显示给独特访客的平均展示次数。 对于某些内容库，发布者不会传递设备标识符，并且这些展示次数未包含在此值中。 [!UICONTROL Frequency (by App/Site)]报表中有一个类似的量度，但该量度并未进行估计。 |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Impressions (Device/Browser)] | （包含在[!UICONTROL Frequency (by Impression)]报表中）给定频率分组的预计展示次数。 Advertising Cloud估计基于展示次数的样本。 对于某些内容库，发布者不会传递设备标识符，并且这些展示次数未包含在此值中。 [!UICONTROL Frequency (by App/Site)]报表中有一个类似的量度，但该量度并未进行估计。 |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Uniques (Device/Browser)] | （包含在[!UICONTROL Frequency (by Impression)]报表中）按给定频率记录的独特浏览器或设备的数量。 Advertising Cloud估计基于展示次数的样本。 对于某些内容，请勿传递设备标识符，并且这些展示次数未包含在此值中。 [!UICONTROL Frequency (by App/Site)]报表中有一个类似的量度，但该量度并未进行估计。 |
...
| [!UICONTROL Metric] |  | [!UICONTROL Performance] | [!UICONTROL Gross CPA] | 每次购置的平均总成本，由[!UICONTROL Gross Spend] / [!UICONTROL Custom Goal]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPC] | 每次广告点击的平均总成本，由[!UICONTROL Gross Spend] / [!UICONTROL Total Ad Clicks]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPCV] | 每次完成视频查看的平均成本，由[!UICONTROL Gross Spend] / [!UICONTROL 100% Completions]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPM] | 每1000次展示的平均成本，由[!UICONTROL Gross Spend] / [!UICONTROL Impressions] x 1000计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPV] | 每次视频查看的平均成本，由[!UICONTROL Gross Spend] / [!UICONTROL Views]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross vCPM] | 每1000个可查看展示次数的平均成本，由[!UICONTROL Gross Spend] / [!UICONTROL Viewable Impressions] x 1000计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPC] | 每次广告点击的平均净成本，由[!UICONTROL Net Spend] / [!UICONTROL Total Ad Clicks]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPCV] | 每次完成视频查看的平均净成本，由[!UICONTROL Net Spend] / [!UICONTROL 100% Completions]计算 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPM] | 每1000次展示的平均净成本，由[!UICONTROL Net Spend] / [!UICONTROL Impressions] x 1000计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPV] | 每次视频查看的平均净成本，由[!UICONTROL Net Spend] / [!UICONTROL Views]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Data eCPM] | 每1000次展示的平均净数据成本，由[!UICONTROL Net Spend (Data)] / [!UICONTROL Impressions] x 1000计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Media CPM] | 每1000次展示的平均净媒体成本，由[!UICONTROL Net Spend (Media)] / [!UICONTROL Impressions] x 1000计算。 |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Other eCPM] | 其他费用的每1000次展示次数的平均净成本，按[!UICONTROL Net Spend (Other)] / [!UICONTROL Impressions] x 1000计算。 |
...
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Margin %] | （激活边距管理时）边距百分比，它由([!UICONTROL Gross Spend] - [!UICONTROL Net Spend])/ [!UICONTROL Gross Spend]计算。 |
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Media Cost] | 不可计费和可计费的媒体成本总和，无需支付任何技术费用。 |
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Net vCPM] | 每1000个可查看展示次数的平均净成本，由[!UICONTROL Net Spend] / [!UICONTROL Viewable Impressions] x 1000计算。 |
...
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Total Net Spend] | [!UICONTROL Net Spend (Media)]、[!UICONTROL Net Spend (Data)]和[!UICONTROL Net Spend (Other)]之和。 |
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Total Non-Billable Net Spend] | [!UICONTROL Non-billable Spend (Media)]、[!UICONTROL Non-billable Spend (Data)]和[!UICONTROL Non-billable Spend (Other)]之和。 |
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Total Other Net Spend] | 其他服务费用的净成本总额（第三方验证合作伙伴、广告服务等）。 |
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Total Billable Net Spend] | [!UICONTROL Billable Spend (Media)]、[!UICONTROL Billable Spend (Data)]和[!UICONTROL Billable Spend (Other)]之和。 |
...
| [!UICONTROL Metric] | [!UICONTROL Viewability] | [!UICONTROL Measurable Rate (%)] | 根据可见性度量的展示次数百分比，计算为[!UICONTROL Measurable Impressions] x 1000 / [!UICONTROL Impressions]。 |
...
| [!UICONTROL Metric] | [!UICONTROL Viewability] | [!UICONTROL Viewability Rate (%)] | 可查看展示次数在所有可衡量展示次数中的百分比，计算方式为[!UICONTROL Viewable Impressions] / [!UICONTROL Measurable Impressions]。 |
...
| [!UICONTROL Custom Goals] | [在报表设置中按广告商分组] | [广告商特定的自定义目标] | 指定[自定义目标](/help/dsp/optimization/custom-goal-about.md)中包含的所有转化的加权总和。 |
