---
title: Adobe Advertising Cloud广告要求政策
...
# Adobe Advertising Cloud广告要求政策

*上次更新时间：2021年7月12日*

*对于Adobe Advertising Cloud DSP和Adobe Advertising Cloud Search*

本广告要求政策（“政策”）规定了通过Adobe的Advertising Cloud按需服务（“服务”）分发的广告的要求。 本政策通过参考纳入Adobe与客户（“您”）之间使用按需服务的协议中。 本政策中使用但未在此定义的大写术语将具有本协议中所述的含义。
...
您通过按需服务传输、存储、显示、分发或以其他方式提供的所有广告必须符合Adobe Advertising Cloud广告规范中包含的广告规范，因为Adobe可能会不时修订这些规范。
...
* **可恶的广告**。广告不得促进或与仇恨言论或宗教不容忍有关，不得基于个人或群体的种族或族裔出身、宗教、残疾、医疗或遗传状况、年龄、国籍或民族出身、退伍军人地位、难民地位、移民地位、性取向、性别、性别认同或与系统性歧视或边缘化有关的其他特征来诋毁个人或群体。

* **敏感事件**。广告可能不利用或缺乏对自然灾害、冲突、死亡、流行病、大流行病、悲剧事件或公众恐惧的合理敏感。

* **传销计划**。广告不能推广传销计划、多层次营销机会、连锁信或其他“快速致富”计划。 任何包含创收机会的广告都必须包含完整的商业模式说明。

* **出售身体部件**。广告不得促进身体部位或体液的销售。

* **分散注意力的广告**。广告不能包含让人分心、不受欢迎或不舒服的功能或内容，包括自动播放功能（如自动播放音频或视频的广告）、闪光、震动、发布、链接或包含过度动画的对象、文本或图像、本地共享对象（包括Flash Cookie和HTML5本地存储），以及中断用户体验的广告（例如，在其他内容上叠加）。
...
* **禁止定位**。无论是已知还是推断，基于以下任何因素，不得将广告定位到或定向到受众：
