---
title: Adobe Advertising Cloud对《加州消费者隐私法案》的支持：消费者数据访问和删除支持
...
本文档介绍Advertising Cloud Search、Advertising Cloud Creative、Advertising Cloud DSP(Demand Side Platform)和 [!DNL Media Optimizer DCO]  — 作为服务提供商 — 支持消费者使用Adobe访问和删除个人信息的权利 [!DNL Experience Platform Privacy Service API] 和 [!DNL Privacy Service UI].
...
1. 部署JavaScript库以检索和删除客户的Cookie。 同一个图书馆， `AdobePrivacy.js`，用于所有Adobe Experience Cloud解决方案。
   ...
   >[!IMPORTANT]
   >
   >对某些Experience Cloud解决方案的请求不需要JavaScript库，但对Advertising Cloud的请求需要它。
